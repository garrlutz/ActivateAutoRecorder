...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="e2e4ce05-dc17-4278-a9ba-9a82cf8486a6"
                type="wpfhost"
                hostedType="Addons\ActivateAutoReorder\ActivateAutoReorder.dll,ActivateAutoReorder.ControlUI"
                enable="true"/>
    ...
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="e2e4ce05-dc17-4278-a9ba-9a82cf8486a6"/>
        </container>
